...
export const metadata: Metadata = {
  title: "Contact",
  description: "Contact Biplob Taxi Service by phone or WhatsApp for taxi booking in Assam and Northeast India."
};
  ...
  return (
    <>
      <PageHero
        ...
        text="Share pickup, destination and date to receive vehicle availability and fare guidance from Biplob Taxi Service."
        icon={Phone}
      />
      <section className="py-16 sm:py-20">
        <div className="mx-auto grid max-w-7xl gap-8 px-4 sm:px-6 lg:grid-cols-[0.85fr_1fr] lg:px-8">
          <div className="rounded-md bg-zinc-950 p-6 text-white sm:p-8">
            <h2 className="text-3xl font-black">Biplob Taxi Service</h2>
            <div className="mt-6 grid gap-4">
              ...
              <WhatsAppLink className="flex items-center gap-3 rounded-md border border-white/10 bg-white/[0.04] p-4 font-bold hover:bg-white/10" message="Hello Biplob Taxi Service, I want to book a taxi from [Pickup] to [Destination] on [Date].">
      ...
      <section className="bg-white pb-16 sm:pb-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="overflow-hidden rounded-md border border-zinc-200 shadow-sm">
            <iframe
              title="Biplob Taxi Service location map"
